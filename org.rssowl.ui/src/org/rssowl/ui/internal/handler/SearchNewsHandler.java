 ...
 * programmatic added actions like opening the search news dialog.
 *
 * @author bpasero
 */
public class SearchNewsHandler extends AbstractHandler {
  ...
  public Object execute(ExecutionEvent event) {
    ...
    if (shell != null) {
      SearchNewsDialog dialog = new SearchNewsDialog(shell);
      dialog.open();
    }
